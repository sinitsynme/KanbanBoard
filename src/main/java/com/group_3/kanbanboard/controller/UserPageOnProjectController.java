...
public class UserPageOnProjectController {

    private final PrincipalService principalService;
    private final UserDetailsService userDetailsService;
    private final UserService userService;

    public UserPageOnProjectController(@Qualifier("userDetailsServiceImpl") UserDetailsService userDetailsService, UserService userService, PrincipalService principalService) {
    ...
    public ModelAndView getPrincipalProfile(){
        ModelAndView modelAndView = new ModelAndView("setUserRoleOnProject");
